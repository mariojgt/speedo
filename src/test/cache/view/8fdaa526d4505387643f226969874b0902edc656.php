...
<head>
    ...
    <title>Request not found 404</title>
</head>
<body>
		...
		<div class="row">
			<div class="col-sm-8 offset-sm-2 text-gray-50 text-center -mt-52">
				...
				<h1 class="relative text-9xl tracking-tighter-less text-shadow font-sans font-bold">
					...
					<span class="absolute  top-0   -ml-12  text-gray-300 font-semibold">Speedo Oops!</span>
					</div>
...
<?php /**PATH C:\xampp\htdocs\speedo\src\App\Views/core/404.blade.php ENDPATH**/ ?>